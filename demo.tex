...
% `rust-defs` style with `boxed` and the additional trait `Baz` and `Bar`
\begin{lstlisting}[style=boxed,style=rust-defs,morekeywords={[3]Baz,Bar}]
/// A good struct
